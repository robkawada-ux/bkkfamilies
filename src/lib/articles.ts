...
export const ARTICLES: Article[] = [
  {
    ...
    category: "Local Life",
    date: "2026-09-10",
    metaDescription: "We raised two third culture kids in Bangkok from 2011 to 2020, then moved them to the US. What the research gets right about re-entry, what it misses, and the one thing I would do differently.",
    ...
    headings: [
      ...
      { beforeParagraph: 22, text: "Then we landed in a pandemic" },
      { beforeParagraph: 28, text: "The honest trade" },
      { beforeParagraph: 32, text: "The language mistake I could not fix" },
      { beforeParagraph: 36, text: "What I would do differently" },
      { beforeParagraph: 41, text: "Keeping the roots" },
      { beforeParagraph: 45, text: "Where they are now" },
    ],
    relatedSchools: [
    ...
    body: [
      ...
      "My kids were not devastated to leave Bangkok. They were excited. America was the warm place with summer camp, and they were going to live there. We threw a party. We said our goodbyes properly to people we loved, and there were real tears in that, but the overall mood in our house was anticipation, not loss.",
      "If you are reading TCK material and bracing for a child in mourning at the airport, you might get that. You might also get what we got, which is a kid who is genuinely thrilled and a parent who quietly assumes that means the hard part has been skipped.",
      "It had not been skipped. It had been deferred.",
